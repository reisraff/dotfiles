...
case "$TERM" in
    xterm-color|*-256color|alacritty|screen) color_prompt=yes;;
esac
...
export ANDROID_SDK_ROOT=/home/reisraff/Android/Sdk
export PATH=$PATH:/home/reisraff/.local/bin/
